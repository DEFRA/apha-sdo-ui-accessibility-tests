...
export const config = {
  ...
  baseUrl: `https://apha-sdo-ui-accessibility-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `apha-sdo-ui-accessibility-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `apha-sdo-ui-accessibility-tests-${process.env.ENVIRONMENT}`
        },
